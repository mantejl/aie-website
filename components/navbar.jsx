...
useEffect(() => {
  ...
  return (
    <nav className={`sticky top-5 z-50 w-full flex justify-center mt-6 bg-transparent transition-all duration-1000 ${
      ...
      <div className="flex items-center bg-white rounded-2xl shadow-lg px-8 py-4">
        <div className="flex-1 flex justify-center gap-12">
          ...
          <Link href="/hackathon" className="text-purple-900 font-normal text-m hover:text-purple-700 transition-transform duration-200 hover:scale-110">Hackathon</Link>
        </div>
      </div>
    </nav>
  );
